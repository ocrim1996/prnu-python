Before running the code you need to download the `drunet_gray.pth` and `drunet_color.pth` files from the following links and place them in this `model_zoo` folder.
